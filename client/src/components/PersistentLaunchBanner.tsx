...
const REPEATED_LABELS = Array.from({ length: 8 }, (_, index) => `${BANNER_TEXT} — `);
  ...
  return (
    ...
    >
      ...
      <div className="launch-banner-track flex h-full w-max items-center whitespace-nowrap font-semibold tracking-[0.12em]" aria-hidden="true">
        <span className="flex shrink-0 items-center gap-5 px-5 text-sm sm:gap-7 sm:px-7 sm:text-base">
