...
const ceoContent = {
  ar: {
    ...
    paragraphs: [
      ...
      "ندعو كافة شركائنا في القطاعين العام والخاص للانضمام إلينا في هذه الرحلة نحو الريادة العالمية، لنعمل معاً على بناء مستقبل مهني آمن ومزدهر لأبناء وبنات هذا الوطن العطاء..",
    ],
  },
  en: {
