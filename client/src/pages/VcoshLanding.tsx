...
const t = {
  ...
  ar: {
    ...
    howItWorks: {
      ...
      steps: [
        { num: "1", title: "انشر في أيام", desc: "يتم تشغيل النظام خلال أيام بطريقة منظمة، ويستطيع الموظفون تحميل التطبيق والبدء باستخدامه مباشرة." },
    ...
    features: {
      ...
      pillars: [
        ...
        { emoji: "🎁", tag: "", title: "سوق المكافآت", desc: "نظام مكافآت يتيح استبدال النقاط بمزايا حقيقية.", img: FEAT_REWARDS },
    ...
    whyVcosh: {
      ...
      reasons: [
        { emoji: "🏛️", title: "مصمم خصيصًا لبيئة العمل في المملكة العربية السعودية", desc: "مبني من الصفر تحت إشراف المعهد الوطني ومعتمد من المجلس الوطني. الامتثال والملاءمة الثقافية مدمجان فيه — وليسا مضافَين لاحقاً." },
        { emoji: "🦺", title: "يركز على الصحة المهنية بشكل متكامل وليس فقط على الرفاهية", desc: "مبني على علم السلامة المهنية للمعهد الوطني — يشمل الإبلاغ عن المخاطر واختبار العمر الحقيقي والاستشارات السريرية. وليس مجرد عداد خطوات." },
        { emoji: "🎁", title: "مكافآت حقيقية تعزز الاستخدام المستمر", desc: "أكثر من 100 شريك من العلامات التجارية. يكسب الموظفون نقاطاً ويستبدلون قسائم حقيقية — وليس شارات. هذا ما يدفع التفاعل اليومي المستدام." },
        { emoji: "📊", title: "يوفّر نتائج قابلة للقياس تدعم قرارات الإدارة", desc: "تتتبع لوحة تحكم الموارد البشرية المشاركة واتجاهات الصحة وانخفاض الغياب. يمكنك إثبات للمجلس بالضبط ما يحققه استثمارك في العافية." },
        { emoji: "🩺", title: "يجمع بين التقنية الحديثة ودعم المختصين", desc: "يتواصل الموظفون مع متخصصي الصحة المهنية الحقيقيين — وليس مجرد روبوتات دردشة بالذكاء الاصطناعي. أداة بمستوى سريري لا تستطيع تطبيقات العافية العامة تقديمها." },
      ],
    },
    rewards: {
      tag: "منظومة المكافآت",
    ...
    finalCta: {
      ...
      body: "ابدأ الآن وتعرّف على كيف يمكن لهذا النظام أن يساعدك في تقليل الغياب وتحسين التفاعل وتحقيق نتائج واضحة.",
      cta: "← احجز استشارة معنا",
    },
    footer: {
