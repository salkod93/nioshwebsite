  ...
  ar: {
    ...
    howItWorks: {
      ...
      steps: [
        ...
        { num: "3", title: "قياس الأثر", desc: "توفر لوحة التحكم تقارير دقيقة حول التفاعل والصحة ونسب الغياب، مما يساعد الإدارة على اتخاذ قرارات مبنية على بيانات." },
      ],
    },
    features: {
      tag: "المركز",
      ...
      <div className="relative max-w-7xl mx-auto px-6 py-8 lg:py-12 w-full min-h-screen flex items-center">
        ...
        <div className="flex flex-col lg:flex-row gap-8 lg:gap-12 items-stretch lg:items-center">
          ...
          <div className={`flex flex-col justify-center flex-1 ${isRTL ? "text-right" : "text-left"}`}>
            ...
            <div className={`inline-flex items-center gap-2 mt-4 sm:mt-3 lg:mt-0 mb-4 px-4 py-2 rounded-full border border-emerald-400/40 bg-emerald-900/20 backdrop-blur-sm w-fit ${isRTL ? "flex-row-reverse" : ""}`}>
