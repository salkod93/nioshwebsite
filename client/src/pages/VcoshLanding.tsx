...
const t = {
  ...
  ar: {
    ...
    whatIs: {
      ...
      body: "VCOSH هو أول منصة سعودية للصحة المهنية وصحة القوى العاملة — مبنية تحت إشراف المعهد الوطني للسلامة والصحة المهنية ومعتمدة من المجلس الوطني للسلامة والصحة المهنية. إنها ليست تطبيق عافية عادياً، بل نظام مدعوم سريرياً ومعتمد حكومياً مصمم للقوى العاملة في المؤسسات السعودية.",
      cards: [
    ...
    whyVcosh: {
      ...
      reasons: [
        { emoji: "🏛️", title: "سعودي أولاً، وليس معدّلاً", desc: "مبني من الصفر تحت إشراف المعهد الوطني ومعتمد من المجلس الوطني. الامتثال والملاءمة الثقافية مدمجان — وليسا مضافَين لاحقاً." },
        { emoji: "🌍", title: "9 لغات للقوى العاملة الحقيقية", desc: "المنصة الوحيدة للصحة المهنية التي تخدم العمال الناطقين بالعربية والهندية والبنغالية والتاغالوغ والسنهالية والأمهرية والأردية بلغتهم الأم." },
    ...
    rewards: {
      ...
      endorsements: [
        ...
        { logo: null, emoji: "🌐", title: "نموذج عالمي مثبت", desc: "أثبتت منصات صحة القوى العاملة عالمياً انخفاضاً بنسبة 28-36% في الغياب وعائداً استثمارياً بنسبة 6:1 على الاستثمار في صحة القوى العاملة. VCOSH يجلب هذا إلى المملكة العربية السعودية." },
      ],
    },
    finalCta: {
      badge: "شراكات استراتيجية محدودة متاحة",
      title: "هل أنت مستعد لتحويل\nقوتك العاملة؟",
      body: "احجز مكالمة مباشرة مع فريقنا لاستكشاف نشر VCOSH المخصص لمؤسستك — وشاهد بالضبط كيف سيقلل الغياب ويعزز التفاعل ويحقق عائداً استثمارياً قابلاً للقياس.",
